...
public enum __IMPL_Microsoft_UI_Xaml {
    ...
    public enum IXamlServiceProviderBridge : AbiInterfaceBridge {
        public typealias CABI = __x_ABI_CMicrosoft_CUI_CXaml_CIXamlServiceProvider
        public typealias SwiftABI = __ABI_Microsoft_UI_Xaml.IXamlServiceProvider
        public typealias SwiftProjection = AnyIXamlServiceProvider
        public static func from(abi: ComPtr<CABI>?) -> SwiftProjection? {
            guard let abi = abi else { return nil }
            return IXamlServiceProviderImpl(abi)
        }

        public static func makeAbi() -> CABI {
            let vtblPtr = withUnsafeMutablePointer(to: &__ABI_Microsoft_UI_Xaml.IXamlServiceProviderVTable) { $0 }
            return .init(lpVtbl: vtblPtr)
        }
    }

    fileprivate class IXamlServiceProviderImpl: IXamlServiceProvider, WinRTAbiImpl {
        fileprivate typealias Bridge = IXamlServiceProviderBridge
        fileprivate let _default: Bridge.SwiftABI
        fileprivate var thisPtr: WindowsFoundation.IInspectable { _default }
        fileprivate init(_ fromAbi: ComPtr<Bridge.CABI>) {
            _default = Bridge.SwiftABI(fromAbi)
        ...
        fileprivate func getService(_ type: WinUI.TypeName) throws -> Any! {
            try _default.GetServiceImpl(type)
        }
    ...
    public class EnteredBackgroundEventHandlerBridge : WinRTDelegateBridge {
        public typealias Handler = EnteredBackgroundEventHandler
        public typealias CABI = __x_ABI_CMicrosoft_CUI_CXaml_CIEnteredBackgroundEventHandler
        public typealias SwiftABI = __ABI_Microsoft_UI_Xaml.EnteredBackgroundEventHandler
    ...
    public class LeavingBackgroundEventHandlerBridge : WinRTDelegateBridge {
        public typealias Handler = LeavingBackgroundEventHandler
        public typealias CABI = __x_ABI_CMicrosoft_CUI_CXaml_CILeavingBackgroundEventHandler
        public typealias SwiftABI = __ABI_Microsoft_UI_Xaml.LeavingBackgroundEventHandler
    ...
    public class SuspendingEventHandlerBridge : WinRTDelegateBridge {
        public typealias Handler = SuspendingEventHandler
        public typealias CABI = __x_ABI_CMicrosoft_CUI_CXaml_CISuspendingEventHandler
        public typealias SwiftABI = __ABI_Microsoft_UI_Xaml.SuspendingEventHandler
